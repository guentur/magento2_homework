...
class LoadFeedbackProductsInCollection implements ObserverInterface
{
    /**
    ...
    {
        $feedbackCollection = $observer->getFeedbackCollection();
        foreach ($feedbackCollection as $feedback) {
            /** @var \Training\Feedback\Api\Data\FeedbackInterface $feedback */
            $productIds = $this->feedbackProducts->loadProductRelations($feedback->getId());
